  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, obj) => (
        ...
        >
          <a className="!text-white w-[20px] !w-[200px] !rounded-full ">
            <DeleteOutlined className="w-[30px] bg-red-500 flex justify-center rounded-full h-[30px]" />
          </a>
        </Popconfirm>
      ),
    },
  ...
  return (
    <AdminLayout>
      <div className="  justify-center w-full bg-zinc-100 h-screen">
        ...
        <h2 className="md:text-2xl text-center w-full p-2 px-12 mb-4 text-zinc-500 text-left font-semibold">
          User User Registeration Form
        </h2>
          ...
          <Card className="!bg-zinc-50 !shadow !border !rounded-none !border-zinc-300 !shadow-sm">
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-2 bg-zinc-50 p-1">
                ...
                <div className="w-full md:w-1/2">
                  <Form.Item className="!mb-1" label="Mobile" name="mobile">
                    <Input className="w-full" />
                  </Form.Item>
                </div>
              </div>
              <div className="flex flex-col md:flex-row gap-2  p-1">
                ...
                <div className="w-full md:w-1/2">
                  <Form.Item className="!mb-1" label="Role" name="role">
                    <Select
                      showSearch
              ...
              <div className="py-4 !mb-1">
                <Form.Item>
                  <Button
                    type="text"
                    htmlType="submit"
                    className="md:!w-60 !bg-orange-500 !text-white !font-semibold hover:!bg-green-500 hover:!text-white hover:!shadow-lg hover:!shadow-black "
                  >
        ...
        <h1 className=" text-xl md:text-xl p-4 font-semibold !text-zinc-800">
          Users
        </h1>
        <Table
          size="small"
