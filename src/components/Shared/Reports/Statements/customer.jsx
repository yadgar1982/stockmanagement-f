...
">
  ...
  const handlePrintAllCustomers = () => {
    ...
    const totalBalance = allCustomerBalance.reduce((sum, s) => sum + s.balance, 0);

    newWindow.document.title = "All customers Balances";
    ...
    <div style="font-family: Arial; padding: 10px; background: white; color: #212529;">
      <header style="width: 100%; text-align: center; margin-bottom: 20px;">
        ...
        <div style="text-align:left; margin-top:5px;">
          <div style="font-size:14px; font-weight:bold; color:#5a5b5cff;">All customers Balances</div>
      ...
      <table style="width: 100%; border-collapse: collapse; margin-top: 15px; font-size: 12px; color: #212529;">
        <thead>
          <tr style="background-color: #f8f9fa; text-align: left;">
            <th style="border-bottom: 1px solid #dee2e6; padding:4px 6px;">customer</th>
        ...
        <tbody>
          ${allCustomerBalance.map((s, index) => {
      const rowColor = index % 2 === 0 ? "#ffffff" : "#f1f3f5";
      return `
              <tr style="background-color: ${rowColor};">
                <td style="padding:3px 6px;">${s.customerName}</td>
        ...
        <tfoot>
          <tr style="font-weight:bold; border-top: 1px solid #dee2e6; background-color: #f8f9fa;">
            <td colspan="3" style="padding:4px 6px;">Total customer Balance</td>
